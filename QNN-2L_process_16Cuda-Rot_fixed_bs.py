...
if __name__ == '__main__':
    ...
    for seed in range(0, n_seeds):
        ...
        params_i = []
        params_o_epoch = []
        [params_i.append(parameter.to('cpu')) for parameter in model.parameters()]
        ...
        trainingEpoch_loss_sum.append(trainingEpoch_loss)#.to('cpu'))
        validationEpoch_loss_sum.append(validationEpoch_loss)#.to('cpu'))
        train_accuracy_sum.append(train_accuracy)#.to('cpu'))
        val_accuracy_sum.append(val_accuracy)#.to('cpu'))
