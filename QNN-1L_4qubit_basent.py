...
#                                              transform=transforms.Compose([torchvision.transforms.ToTensor(), norm02]))
        trainset = torchvision.datasets.MNIST(root='/ifxhome/faierr/projects/qml-cybrex/models/data/', train=True, download=True, transform=transforms.Compose([torchvision.transforms.ToTensor(), norm02]))
        testset = torchvision.datasets.MNIST(root='/ifxhome/faierr/projects/qml-cybrex/models/data/', train=False, download=True, transform=transforms.Compose([torchvision.transforms.ToTensor(), norm02]))
...
ent1 = "basent"
identity = "nopool_MNIST"
#bs = f"bs{batch_size}"

directory: str = f"/ifxhome/faierr/projects/qml-cybrex/models/results/{identity}/{ent1}_{identity}/"
os.makedirs(os.path.dirname(directory), exist_ok=True)
                           
qml.draw_mpl(qnode2, decimals=2)(inputs=['inp1', 'inp2', 'inp3', 'inp4'], weights=[['w1', 'w2', 'w3', 'w4']])#weights=[['w11', 'w12', 'w13', 'w14'],['w21', 'w22', 'w23', 'w24']])
